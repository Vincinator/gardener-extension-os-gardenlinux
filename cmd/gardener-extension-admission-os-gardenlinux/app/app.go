...
import (
	...
	memoryOneGardenlinuxInstall "github.com/gardener/gardener-extension-os-gardenlinux/pkg/apis/memoryonegardenlinux/install"
...
const AdmissionName = "admission-os-gardenlinux"

var log = logf.Log.WithName("gardener-extension-admission-os-gardenlinux")

// NewAdmissionCommand creates a new command for running a gardenlinux admission webhook.
func NewAdmissionCommand(ctx context.Context) *cobra.Command {
	var (
		...
		mgrOpts  = &controllercmd.ManagerOptions{
			...
			WebhookCertDir:          "/tmp/admission-os-gardenlinux-cert",
		}
	...
	cmd := &cobra.Command{
		Use: fmt.Sprintf("admission-%s",gardenlinux.OSTypeGardenLinux),
